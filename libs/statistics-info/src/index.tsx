      ...
      {statistics ? (
        <>
          ...
          <Flex w="100%">
            ...
            <Box flex="1">
              <Text fontSize="sm">
                {statistics.currentRoundTripTime * 1000} ms
              </Text>
            </Box>
          </Flex>
          <Flex w="100%">
            ...
            <Box flex="1">
              <Text fontSize="sm">
                {statistics.availableOutgoingBitrate / 1000} kbps
              </Text>
            </Box>
          </Flex>
          <Flex w="100%">
          ...
          <Flex w="100%">
            ...
            <Box flex="1">
              <Text fontSize="sm">
                {statistics.video?.outbounds[0].qualityLimitationReason}
              </Text>
            </Box>
          </Flex>
          <Flex w="100%">
            ...
            <Box flex="1">
              <Text fontSize="sm">
                {statistics.video?.outbounds[0].framesPerSecond}
              </Text>
            </Box>
          </Flex>
          <Flex w="100%">
            ...
            <Box flex="1">
              <Text fontSize="sm">
                {statistics.video?.outbounds[0].bitrate / 1000} kbps
              </Text>
            </Box>
          </Flex>
          <Flex w="100%">
            ...
            <Box flex="1">
              <Text fontSize="sm">
                {statistics.audio?.outbounds[0].bitrate / 1000} kbps
              </Text>
            </Box>
          </Flex>
          <Flex w="100%">
            ...
            <Box flex="1">
              <Text fontSize="sm">
                {statistics.video?.outbounds[0].totalBytesSent / 1000} KB
              </Text>
            </Box>
          </Flex>
          <Flex w="100%">
            ...
            <Box flex="1">
              <Text fontSize="sm">
                {statistics.audio?.outbounds[0].totalBytesSent / 1000} KB
              </Text>
            </Box>
          </Flex>
          <Flex w="100%">
            ...
            <Box flex="1">
              <Text fontSize="sm">
                {statistics.video?.outbounds[0].mimeType},{" "}
                {statistics.audio?.outbounds[0].mimeType}
              </Text>
            </Box>
          </Flex>
          <Flex w="100%">
