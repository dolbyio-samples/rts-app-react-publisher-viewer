...
const SvgInfo = ({ fill, ...rest }: SVGProps<SVGSVGElement>) => (
  <svg fill="none" height="100%" viewBox="0 0 25 24" width="100%" xmlns="http://www.w3.org/2000/svg" {...rest}>
    <g clipPath="url(#clip0_6216_14502)">
      <path
        ...
        strokeWidth="0.3"
      />
      <rect fill={fill || 'currentColor'} height="1" rx="0.5" width="8" x="9.5" y="9" />
      <rect fill={fill || 'currentColor'} height="1" rx="0.5" width="8" x="9.5" y="12" />
      <rect fill={fill || 'currentColor'} height="1" rx="0.5" width="8" x="9.5" y="15" />
    </g>
    <defs>
      <clipPath id="clip0_6216_14502">
        <rect fill="white" height="24.2" transform="translate(2.5)" width="19.2" />
      </clipPath>
    </defs>
  </svg>
);
